...
class FaqPolicy
{
    ...
    {
        if ($user->can('faq.edit') && $user->id == $faq->created_by_id) {
            return true;
        }
    }
    ...
    {
        if ($user->can('faq.destroy') && $user->id == $faq->created_by_id) {
            return true;
        }
    }
    ...
    {
        if ($user->can('faq.restore') && $user->id == $faq->created_by_id) {
            return true;
        }
    }
    ...
    {
        if ($user->can('faq.forceDelete') && $user->id == $faq->created_by_id) {
            return true;
        }
    }
}
